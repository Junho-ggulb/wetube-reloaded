...
var startGithubLogin = function startGithubLogin(req, res) {
  ...
  var fianlUrl = "".concat(baseUrl, "?").concat(params);
    ...
    return regeneratorRuntime.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            _req$session$user = req.session.user, _id = _req$session$user._id, avatarUrl = _req$session$user.avatarUrl, _req$body3 = req.body, name = _req$body3.name, email = _req$body3.email, username = _req$body3.username, location = _req$body3.location, file = req.file; // const exists = await User.exists({ $or: [{ username, email }] })
          ...
          case 3:
            ...
            return _context4.abrupt("return", res.redirect("edit"));
